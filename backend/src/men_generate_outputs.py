...
output_df['experience_weighted_production'] = df['experience_weighted_production'].values
output_df['effective_possession_rate'] = df['effective_possession_rate'].values
output_df['def_effective_possession_rate'] = df['def_effective_possession_rate'].values
output_df['three_point_volume_efficiency'] = df['three_point_volume_efficiency'].values
output_df['def_three_point_volume_efficiency'] = df['def_three_point_volume_efficiency'].values
output_df['perimeter_efficiency'] = df['perimeter_efficiency'].values
output_df['def_perimeter_efficiency'] = df['def_perimeter_efficiency'].values
output_df['rim_efficiency'] = df['rim_efficiency'].values
output_df['def_rim_efficiency'] = df['def_rim_efficiency'].values
output_df['four_factors_composite'] = df['four_factors_composite'].values
output_df['def_four_factors_composite'] = df['def_four_factors_composite'].values
